...
// ------------------------------------------------------------
// 實機版需要：
// 1. 燈光 MQTT Broker: 127.0.0.1:1883
// 2. 心律/血氧 MQTT Broker: 127.0.0.1:1883
// 3. 環境監測 MQTT Broker: 127.0.0.1:1883
// 4. SmartLight NODE：bedroom01
// 3. Node.js Bridge：server/dashboard-mqtt-bridge.js
// 4. WebSocket：/ws/dashboard
window.DASHBOARD_CONFIG = {
  // dev / mqtt
  // mqtt：實機版，透過 Node.js Bridge → MQTT Broker → SmartLight NODE。
  runtimeMode: 'mqtt',
